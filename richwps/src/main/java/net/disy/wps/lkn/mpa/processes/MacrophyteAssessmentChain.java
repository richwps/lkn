...
public class MacrophyteAssessmentChain extends AbstractAnnotatedAlgorithm {

    // Logger fuer Debugging erzeugen
    // use with wps 3.2.0
    protected static org.slf4j.Logger LOGGER = org.slf4j.LoggerFactory.getLogger(MacrophyteAssessmentChain.class);
    //use with wps 3.1.0
     ...
     */
    public MacrophyteAssessmentChain() {
        super();
    ...
    public void run() {
        ...
        try {
            ...
            Logger.getLogger(MacrophyteAssessmentChain.class.getName()).log(Level.SEVERE, null, ex);
            ex.printStackTrace();
        }
